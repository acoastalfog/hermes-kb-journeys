...
def test_generated_descriptor_bundle_is_strict_and_legacy_free(tmp_path, monkeypatch):
    ...
    assert source["engine_version"] == "0.46.2"
    assert source["engine_source_revision"] == "fb78531ea994d9f4a5e8e961fd41deb0768b6ba2"
...
def test_ci_checks_out_exact_private_engine_ref_with_read_only_deploy_key():
    ...
    assert (
        ...
        == "fb78531ea994d9f4a5e8e961fd41deb0768b6ba2"
    )
