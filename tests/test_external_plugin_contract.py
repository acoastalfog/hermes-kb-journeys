...
def test_generated_descriptor_bundle_is_strict_and_legacy_free(tmp_path, monkeypatch):
    ...
    assert source["engine_version"] == "0.46.1"
    assert source["engine_source_revision"] == "31cce402ca22a43c959132e37147b9826b878d0b"
...
def test_ci_checks_out_exact_private_engine_ref_with_read_only_deploy_key():
    ...
    assert (
        ...
        == "31cce402ca22a43c959132e37147b9826b878d0b"
    )
